...
public interface NoticeBasRepository extends JpaRepository<NoticeBas, Integer> {
    ...
    Page<NoticeBas> findNoticeBasByTitleContainingAndUseYn(String keyword, String useYn, Pageable pageable);
    ...
    Page<NoticeBas> findByUseYn(String useYn, Pageable pageable);
}
